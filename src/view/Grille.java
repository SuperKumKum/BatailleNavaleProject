...
public class Grille extends JFrame implements ActionListener {
	public Grille() {
	   ...
	   // C1.aaddActionListener(Croisseur);
	    C1.add(new JButton("Torpilleur"));
	    //C1.aaddActionListener(Torpilleur);
	    C1.add(new JButton("ContreTorpilleur"));
	    //C1.aaddActionListener(ContreTorpilleur);
	    C1.add(new JButton("PorteAvion"));
	    //C1.aaddActionListener(PoteAvion);
	    C1.add(new JButton("SousMarin"));
	    //C1.aaddActionListener(SousMarin);
	    
	    //BoutonListener SousMarin = new BoutonListener();
